      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-3 relative">
          {HOW_IT_WORKS_STEPS.map((step, idx) => (
            <div
              key={step.stepNumber}
              className="rounded-lg bg-[#001226] border border-slate-800 hover:border-[#C5A028]/50 p-4 sm:p-5 flex flex-col justify-between transition-all hover:bg-[#001c3d] group relative"
            ...
            >
              <div>
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-xs font-bold text-[#C5A028] uppercase tracking-widest bg-[#001A33] px-2 py-0.5 rounded border border-slate-800">
                    Step {idx + 1}
                  </span>
                </div>

                <h3 className="font-['Cinzel'] text-base sm:text-lg font-bold text-white group-hover:text-[#C5A028] transition-colors mb-1.5">
                  {step.title}
                </h3>

                <p className="text-xs sm:text-sm font-semibold text-[#C5A028] mb-2">
                  {step.description}
                </p>
              ...
              <div className="mt-4 pt-2.5 border-t border-slate-800 flex items-center gap-1.5 text-xs text-slate-400">
        ...
        {/* Bottom Helper Strip */}
        <div className="mt-8 p-4 sm:p-5 rounded-lg bg-[#001226] border border-[#C5A028]/35 flex flex-col sm:flex-row items-center justify-between gap-3 shadow-xl">
          <div>
            <div className="text-sm sm:text-base font-bold text-white">Have questions about subscription or auction cycles?</div>
          ...
          <button
            ...
            className="w-full sm:w-auto px-5 py-2.5 rounded-md bg-[#C5A028] hover:bg-[#e0b83e] text-[#001A33] font-bold text-xs sm:text-sm uppercase tracking-wider transition-all flex items-center justify-center gap-1.5 shrink-0 cursor-pointer shadow-sm"
