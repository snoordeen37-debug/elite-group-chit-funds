      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            ...
            <div className="w-fit max-w-full inline-flex items-center gap-2.5 sm:gap-4 px-3.5 sm:px-4 py-2 rounded-2xl sm:rounded-full bg-white border border-amber-300 shadow-sm mb-5 flex-wrap sm:flex-nowrap">
              <span className="flex h-2.5 w-2.5 sm:h-3 sm:w-3 rounded-full bg-[#C5A028] animate-pulse shrink-0 ring-4 ring-[#C5A028]/20"></span>
              <span className="font-bold text-xs sm:text-sm md:text-base text-[#001A33] tracking-wide whitespace-nowrap uppercase shrink-0">
                {t('hero.badge')}
              </span>
              <span className="hidden sm:inline-block w-px h-4 bg-amber-300 shrink-0" />
              <span className="text-xs sm:text-sm text-slate-600 font-medium whitespace-nowrap shrink-0">
                {t('hero.location')}
              </span>
            </div>
